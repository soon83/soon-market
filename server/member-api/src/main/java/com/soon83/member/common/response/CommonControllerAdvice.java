...
import com.soon83.member.common.exception.BaseException;
import com.soon83.member.common.interceptor.CommonHttpRequestInterceptor;
...
public class CommonControllerAdvice {
    ...
    public CommonResponse onException(Exception e) {
        ...
        return CommonResponse.failure(ErrorCode.COMMON_SYSTEM_ERROR);
    }

    /**
     * http status: 200 AND result: FAIL
     * 시스템 이슈는 없음, 비즈니스 로직에서 에러 발생
     *
     * @param e
     * @return
     */
    ...
    public CommonResponse onBaseException(BaseException e) {
        ...
        return CommonResponse.failure(e.getMessage(), e.getErrorCode());
    }
